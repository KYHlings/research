...
def get_quiz():
    ...
    questions_base64 = get_all_questions(url)
    ...
    for idx, question_base64 in enumerate(questions_base64):
        ...
        return question, correct_answer, answer_options
...
def quiz():
    ...
    print(f"\nDu ska nu få besvara fyra stycken kluriga quizfrågor inom {category}. Lycka till!")
